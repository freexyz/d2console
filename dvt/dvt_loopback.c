...
static __code const char	*mode_string[] = {
	...
	"CCIR-656i",
	"CCIR-656p",
	"Multi-CH CCIR-656 single edge"
	"Multi-CH CCIR-656 double edge"
};
 ...
 *****************************************************************************
 *
 * CCIR-656 Mode Progressive/Interlace
 *
 *****************************************************************************
 */
...
int dvt_lpbk_multich(void)
{
	...
	siu[1].cf2.b.ext     = 0x0c;
	siu[1].cf2.b.sync    = 0;
	siu[1].cf2.b.sedge   = 0;
	siu[1].cf2.b.hmode   = 0;

//	__iow8(SOU_CLK, __ior8(SOU_CLK) | 0x80);
	...
	sou1->hsync_start		= __le16(4);
	sou1->hsync_end			= __le16(68);
	sou1->hactive_start		= __le16(276);
	sou1->hactive_end		= __le16(276+640*2-1);
	...
	sou1->vactive_end		= __le16(21+480/2);
