...
static __code const char	*fussy_info = {
	"\n" \
	"IPU(CH0)->SOU->SIU(CH0) fussy stitch test\n" \
	"   [IPU] frame buffer:\n" \
...
//	sou0->mode		= 0;		// 0=ccir656, 1=ccir601, 2=raw8, 3=raw10
	...
	ipuc.cf3.b.opmode	= 3;		// 0 = channel indepent
